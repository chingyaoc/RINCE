...
parser.add_argument('--wandb_entity',  default='msr_nssl', type=str, help='wandb entity name')
...
parser.add_argument('--wandb_key',  default=None, type=str, help='wandb personal key')
